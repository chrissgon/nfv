...
$raio = preg_replace("/[^0-9]/", "", filter_input(INPUT_POST, "raio"));
$valMin = filter_input(INPUT_POST, "valMin");
$valMax = filter_input(INPUT_POST, "valMax");
...
$lista_pec = $pecas->buscar_preco($id_mar, $id_mod, $ano, $valMin, $valMax);
...
$_SESSION["ano"] = $ano;
$_SESSION["raio"] = $raio;
$_SESSION["valMin"] = $valMin;
$_SESSION["valMax"] = $valMax;
